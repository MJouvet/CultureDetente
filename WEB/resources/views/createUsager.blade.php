			...
			<div class="panel-body">
				<div class="col-sm-12">
					...
					<form class="form-horizontal panel" action="" method="post" onsubmit="return verifForm(this)">
						...
						<input class="form-control" type="text" name="PrenomUsager" value="" placeholder="Prénom" onblur="return verifPrenom(this)">
						<input class="form-control" type="text" name="Adresse" value="" placeholder="Adresse" onblur="return verifAdresse(this)">
						<input class="form-control" type="email" name="AdresseMail" value="" placeholder="AdresseMail" onblur="return verifMail(this)">
						<input class="form-control" type="date" name="DateInscription" value="" placeholder="Date d'inscription" onblur="return verif_date(this)">
						<input class="form-control" type="text" name="Cotisation" value="" placeholder="Cotisation" onblur="return verifCoti(this)">
						<input class="form-control" type="text" name="NombrePrets" value="" placeholder="Nombre de Prets" onblur="return verifNP(this)">
